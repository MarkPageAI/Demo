...
const BadgePopup = ({ badge, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        {iconUrl ? (
          <img src={iconUrl} alt={`${name} badge`} className="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-4 rounded-full shadow-lg border-4 border-yellow-400 dark:border-learning-yellow" />
        ) : (
